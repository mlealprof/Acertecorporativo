...
Route::get('/rel_ordem', [App\Http\Controllers\ProducaoController::class, 'relatorio_producao']);
Route::post('/producao/relatorio', [App\Http\Controllers\ProducaoController::class, 'filtro_relatorio_producao']);
