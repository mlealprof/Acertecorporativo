                ...
                <tbody>
                    ...
                    @foreach ($resultado->itens as $item)
                       <tr>                        
                            ...
                            <input type="hidden" name= <?php echo 'qt'.$cont;?> value='{{$item->quantidade}}'>
                            <input type="hidden" name= 'id_pedido' value='{{$item->id}}'>
                            <td width="500px">{{$item->descricao}}</td>
                            <input type="hidden" name= <?php echo 'descricao'.$cont;?> value='{{$item->descricao}}'>
                            <td>{{$item->codigo}}</td>
                            <input type="hidden" name= <?php echo 'codigo'.$cont;?> value='{{$item->codigo}}'>
                            ...
                            <td>
                                <input type="text" name= <?php echo 'cor'.$cont;?> size='5px'>
                            </td>
                            <td><textarea class="form-control" id="personalizacao" name=<?php echo 'personalizacao'.$cont;?> rows="3"></textarea> </td>
                            
                       </tr>
                       <input type="hidden" name='qt_itens' value=<?php echo $cont;?>>
