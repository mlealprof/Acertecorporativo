...
<br>
    <CENter><h1>PRODUÇÃO FINALIZADA - <?php echo "(".count($producao_finalizada)." Produtos )"; ?></h1></center>
    <div>
        ...
        <table class="display table table-success table-striped" id='myTable'>
          ...
          <tbody>
             <?php $cont = 1 ?>
              @foreach ($producao_finalizada as $pedido)
                <tr>
                      ...
                      <td>
                            <a href="/bling/pedido/liberados/{{$pedido->id_pedido}}">Ver</a>
                      </td>
                </tr>
                <?php $cont++ ?> 
              @endforeach     
